...
class kitti_object(object):
    ...
    def __init__(self, root_dir, split="training", args=None):
        ...
        self.label_dir = os.path.join(self.split_dir, "kitti_label")
    ...
    def get_label_objects(self, idx):
        ...
        return utils.read_label3d(label_filename)
    ...
    def get_pred_objects(self, idx):
        ...
        if is_exist:
            return utils.read_label3d(pred_filename)
        else:
            return None
...
def show_image_with_boxes(img, objects, calib, show3d=True, depth=None):
    ...
    for obj in objects:
        print("obj size :", obj.xmin ," ", obj.xmax," ",obj.ymin," ",obj.ymax)
        # obj.xmin = obj.xmin * 1.5
        # obj.xmax = obj.xmax * 1.5
        # obj.ymin = obj.ymin * 0.95 --> 应该是设置的输出框大小的问题
        # obj.ymax = obj.ymax * 1.05 --> 应该是设置的输出框大小的问题
...
def dataset_viz(root_dir, args):
    ...
    if args.show_lidar_with_depth:
        import mayavi.mlab as mlab
        # print("init mayavi mlab")
        fig = mlab.figure(
            figure=None, bgcolor=(0, 0, 0), fgcolor=None, engine=None, size=(500, 500)
        )
        print("init mayavi mlab")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="data/test09",
        metavar="N",
        help="input  (default: data/test09)",
    )
    parser.add_argument(
        "-i",
        "--ind",
